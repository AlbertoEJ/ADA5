...
class Grafo:
    ...
    def layout(self):
        ...
        def dibujar_nodo(x, y):
            ...
            pos = (x * 3200, y * 1200)
            pygame.draw.circle(WIN, (0, 255, 23),
                               pos, 8)
        ...
        def dibujar_arista(xy, xj, yx, yj):
            ...
            pygame.draw.line(WIN, (0, 255, 23), pos1, pos2, 3)

        def actualizar_nodo(i):
            posx = (int(x[i][0] * 3200) / 3200) 
            posy = (int(x[i][1] * 1200) / 1200) 
        ...
        def actualizar_arista(xi, xj):
            ...
            newposxy = int(xi[0] * 3200) 
            newposxj = int(xi[1] * 1200)
            newposyx = int(xj[0] * 3200) 
            newposyj = int(xj[1] * 1200)
